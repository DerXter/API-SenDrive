...
* __filtreReservationA(element, id, statut)__: Filtrage des reservations avec chauffeur selon l'élément qui est soit *vehicule* ou *chauffeur*  
* __filtreReservationS(element, id, statut)__: Filtrage des reservations sans chauffeur selon l'élément qui est soit *vehicule* ou *chauffeur*  
...
> __NOTE:__ Le statut est facultatif. S'il n'est pas indiqué, toutes les navettes *En cours*, *Annulé* comme *Terminé* sont affichées.  
* __filtreNavette(idVehicule, idChauffeur, statut)__ : Affichage des navettes selon le vehicule ou le chauffeur   
> __NOTE:__ Le statut est facultatif.
...
* __ajoutFonction(poste)__: Ajout d'une fonction (poste) d'un personnel  
