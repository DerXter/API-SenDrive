<?php
    class Utilisateur{
        ...
        public static function afficheUtilisateurs(){
            global $bdd;
            $reqAfficheUtilisateur = 'SELECT idUtilisateur, prenom, nom, civilite, dateNaissance, numeroIdentite, fonction, adresse, telephone, email, login, statut, idPersonnel, cheminPhoto FROM Utilisateur NATURAL JOIN (Personnel NATURAL JOIN (Fonction NATURAL JOIN Civilite))';
        ...
        public static function afficheUtilisateur($id){
            global $bdd;
            $reqAfficheUtilisateur = 'SELECT idUtilisateur, prenom, nom, civilite, dateNaissance, numeroIdentite, fonction, adresse, telephone, email, login, statut, idPersonnel, cheminPhoto FROM Utilisateur NATURAL JOIN (Personnel NATURAL JOIN (Fonction NATURAL JOIN Civilite)) WHERE idUtilisateur=?';
